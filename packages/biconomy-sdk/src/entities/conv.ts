...
export class Conv {
  ...
  constructor(
    providerOrSigner: JsonRpcProvider | Provider | Signer,
    chainID: number,
    address?: string
  ) {
  ...
  connect(providerOrSigner: JsonRpcProvider | Provider | Signer): this {
...
async function contractInteractionPayable(
  contract: Contract,
  functionName: string,
  arg: any,
  options: TransactionParamsBigInt
